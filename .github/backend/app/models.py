...
class UserProfile(Base):
   ...
   dark_mode: Mapped[str | None] = mapped_column(String(16), nullable=True)  # "dark" | "light" | None
...
class ProductSnapshot(Base):
   ...
   specs_text: Mapped[str | None] = mapped_column(Text, nullable=True)
...
class ReviewSnapshot(Base):
   ...
   sample_reviews_text: Mapped[str | None] = mapped_column(Text, nullable=True)
...
class ComparisonResult(Base):
   ...
   best_value_json: Mapped[str | None] = mapped_column(Text, nullable=True)
